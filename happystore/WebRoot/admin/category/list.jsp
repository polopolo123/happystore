			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach var="c" items="${listCategory }" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/admin/updateCategoryUI?cid=${c.cid}">
										<img
...
<script type="text/javascript">
	function deleteC(cid) {
		if (confirm("您确定要删除该分类吗?")) {
			location.href = "${ pageContext.request.contextPath }/admin/deleteCategory?cid="
					+ cid;
