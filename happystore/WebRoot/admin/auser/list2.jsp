					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="25%">编号</td>
								<td align="center" width="9%">账号</td>
								<td align="center" width="9%">真实姓名</td>
							...
							<c:forEach items="${listUser }" var="lu" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="25%">${lu.uid }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="9%">${lu.username }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="9%">${lu.name }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%">${lu.email }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%">${lu.telephone }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
