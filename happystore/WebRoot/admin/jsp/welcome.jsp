...
<form name="Form1" method="post" action="#" id="Form1">
	...
	<table width="100%" border="0" height="88" border="1" background="${pageContext.request.contextPath}/business/images/back1.JPG">
		<tr>
			<td colspan=3 class="ta_01" align="center" ></td>
		</tr>
