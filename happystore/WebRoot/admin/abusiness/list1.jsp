...
<script type="text/javascript">
	function oktheb(bid) {
		window.location.href = "${pageContext.request.contextPath}/admin/OKBusiness?bid="
				+ bid;
	}
</script>
</HEAD>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="27%">店铺编号</td>
							...
							<c:forEach items="${listBusiness }" var="lb" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="5%"><input type="button" value="批准"
										onclick="oktheb('${lb.bid}')" /></td>
								</tr>
							</c:forEach>
						</table>
					</td>
