	...
	<div class="container-fluid">
		...
		<div class="container-fluid">
			...
			<div class="col-md-2"
				...
				<img src="${pageContext.request.contextPath}/user/products/hao/big01.jpg"
			...
			<div class="col-md-10">
				...
				<div class="col-md-2"
					...
					<a href="product_info.htm"> <img
						src="${pageContext.request.contextPath}/user/products/hao/small03.jpg"
				...
				<div class="col-md-2"
					style="text-align:center;height:200px;padding:10px 0px;">
					<a href="product_info.htm"> <img
						src="${pageContext.request.contextPath}/user/products/hao/small04.jpg"
						width="130" height="130" style="display: inline-block;">
					</a>
					<p>
						<a href="product_info.html" style='color:#666'>冬瓜</a>
				...
				<div class="col-md-2 yes-right-border"
					style="text-align:center;height:200px;padding:10px 0px;">
					<a href="product_info.htm"> <img
						src="${pageContext.request.contextPath}/user/products/hao/small05.jpg"
						width="130" height="130" style="display: inline-block;">
					</a>
					<p>
						<a href="product_info.html" style='color:#666'>冬瓜</a>
		...
		<!--
            ...
            -->
		<div class="container-fluid">
			<img src="${pageContext.request.contextPath}/user/products/hao/ad.jpg"
				width="100%" />
		</div>
		<!--
            	作者：ci2713@163.com
		...
		<div class="container-fluid">
			<div style="margin-top:50px;">
				<img src="${pageContext.request.contextPath}/user/img/footer.jpg"
			...
			<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
				Copyright &copy; 2017  开心商城  版权所有</div>
		</div>
	</div>
</body>
