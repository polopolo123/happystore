...
<body>
	...
	<div class="container"
		...
		<div class="row">
			<div class="col-md-7">
				<!--<img src="${pageContext.request.contextPath}/user/image/login.jpg" width="500" height="330" alt="会员登录" title="会员登录">-->
			</div>
	...
	<div style="margin-top:50px;">
		<img src="${pageContext.request.contextPath}/user/image/footer.jpg"
